...
describe('i18n()', () => {
  it('should create i18n function with default values', () => {
    ...
    const useDefaultI18n = i18nFactory.create({
      namespace: 'default',
      resources: () => ({
  ...
  it('should allow to merge different translations into one', () => {
    ...
    const useDefaultI81n = i18nFactory.create({
      namespace: 'default',
      resources: () => ({
        'Welcome to the page': () => [
    ...
    const useLoginI81n = i18nFactory.create({
      namespace: 'login',
      resources: () => ({
        'Welcome {name}': ({ name }: DynamicValues) => [
        ...
        '{count} Items': ({ count }: { count: number }) => [
          {
            lang: 'en',
            value: {
              default: `${count} Items`,
    ...
    const text1 = [
      ...
      t1['login.Welcome {name}']({ name: 'John Doe' }),
    ...
    const text3 = [
      ...
      t3['login.Welcome {name}']({ name: 'John Doe' }),
      t3['login.Welcome {name}']({ name: 'John Doe', lang: 'en' }),
    ];
    ...
    const text4 = [
      ...
      t1['login.{count} Items']({ count: 0 }),
      t1['login.{count} Items']({ count: 1 }),
      t1['login.{count} Items']({ count: 2 }),
      t1['login.{count} Items']({ count: 20 }),
    ];
